    ...
    implements Serializable, Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ChannelList)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ChannelList that = ((ChannelList) object);
        {
            String lhsId;
            lhsId = this.getId();
            String rhsId;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ChannelList) {
            final ChannelList copy = ((ChannelList) draftCopy);
            if (this.id!= null) {
                String sourceId;
                sourceId = this.getId();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ChannelList) {
            final ChannelList target = this;
            final ChannelList leftObject = ((ChannelList) left);
            final ChannelList rightObject = ((ChannelList) right);
            {
                String lhsId;

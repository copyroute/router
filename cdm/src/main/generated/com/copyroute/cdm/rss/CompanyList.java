    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompanyList)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompanyList that = ((CompanyList) object);
        {
            String lhsId;
            lhsId = this.getId();
            String rhsId;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CompanyList) {
            final CompanyList copy = ((CompanyList) draftCopy);
            if (this.id!= null) {
                String sourceId;
                sourceId = this.getId();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CompanyList) {
            final CompanyList target = this;
            final CompanyList leftObject = ((CompanyList) left);
            final CompanyList rightObject = ((CompanyList) right);
            {
                String lhsId;

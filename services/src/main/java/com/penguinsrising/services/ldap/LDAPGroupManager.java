//package com.penguinsrising.services.ldap;
//
...
//	
//	public LDAPGroupManager(LDAPConnectionParams params) { this.connectionParams = params; }
//	
//	@Override
//	public Group createNewGroup(String groupId) { throw new ActivitiException("LDAP group manager doesn't support creating a new group"); }
//
//	@Override
//	public void insertGroup(Group group) { throw new ActivitiException("LDAP group manager doesn't support inserting a new group"); }
//
//	@Override
//	public void updateGroup(Group updatedGroup) { throw new ActivitiException("LDAP group manager doesn't support updating a new group"); }
//
//	@Override
//	public void deleteGroup(String groupId) { throw new ActivitiException("LDAP group manager doesn't support deleting a new group"); }
//
//	@Override
...
//		  	cursor.close();		  	
//		} 		
//		catch (Exception e) { throw new ActivitiException("LDAP connection search failure", e); }
//		
...
//		  			connection.search(GROUP_ENTRY, "(uniqueMember= uid=" + userId + "," + USER_ENTRY + ")", SearchScope.ONELEVEL, "*");
//		  	while (cursor.next()) 
//		  	{
//		  		Group group = new GroupEntity();
//		  		SearchResultEntry response = (SearchResultEntry) cursor.get();

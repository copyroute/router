...
{$('#connectionStatus').html('<div><img id="connImage" src="/resources/images/connected.png" alt="WebSocket Disconnected"></div>');}

function _connectionBroken()
{$('#connectionStatus').html('<div><img id="connImage" src="/resources/images/disconnected.png" alt="WebSocket Disconnected"></div>');}
